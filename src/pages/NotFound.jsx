...
const NotFound = () => {
  return (
    <div className="min-h-[100dvh]">
      <Navbar />
      <div className="min-h-[calc(100vh-140px)] py-12 md:py-16 lg:py-20">
        <div className="mx-auto flex h-full max-w-md flex-col items-center rounded-md bg-white p-5 shadow-sm sm:p-10">
